...
return [
    ...
    'admin_appearance' => [
        ...
        'form' => [
            ...
            'admin_logo_max_height' => 'Altura del logotipo (px)',
            'admin_logo_max_height_helper' => 'Establezca la altura del logotipo en píxeles. El valor predeterminado es :default.',
        ],
    ],
    'datatable' => [
    ...
    'media' => [
        ...
        'width' => 'Ancho',
        'height' => 'Altura',
        'default_size_value' => 'Por defecto: :size',
        'all' => 'Todo',
        ...
        'max_upload_filesize_placeholder' => 'Por defecto: :size, debe ser menor que :size.',
        'max_upload_filesize_helper' => 'Su servidor permite subir archivos de hasta :size; puede cambiar este valor para limitar el tamaño de los archivos a subir.',
        ...
        'backblaze_access_key_id' => 'ID de clave de acceso de Backblaze',
        'backblaze_secret_key' => 'Clave secreta de Backblaze',
        'backblaze_bucket' => 'Bucket de Backblaze',
        ...
        'backblaze_cdn_enabled' => '¿Está habilitada la CDN de Backblaze?',
        'media_backblaze_cdn_custom_domain' => 'Dominio personalizado de CDN de Backblaze',
        'media_backblaze_cdn_custom_domain_placeholder' => 'https://su-dominio-personalizado.com',
        'watermark_source_helper' => 'Solo se admiten formatos PNG, JPG y JPEG. Debe utilizar una imagen de menos de 200x200px y con un tamaño inferior a 50KB.',
        'enable_thumbnail_sizes' => 'Habilitar tamaños de miniaturas',
        'enable_thumbnail_sizes_helper' => 'Active esta opción para generar miniaturas de las imágenes. Si está desactivada, el sistema no generará miniaturas para las imágenes y siempre usará la imagen a tamaño completo.',
        'convert_image_to_webp' => 'Convertir imagen JPG, JPEG, PNG a WebP',
        'convert_image_to_webp_helper' => 'WebP es un formato de imagen moderno que ofrece una compresión superior, tanto sin pérdida como con pérdida, para imágenes en la web. Es compatible con Chrome, Firefox, Edge y Opera. La imagen se convertirá al formato WebP al cargarla. Solo se aplica a imágenes JPG, JPEG y PNG.',
        'reduce_large_image_size' => 'Reducir el tamaño de las imágenes grandes al subirlas',
        'reduce_large_image_size_helper' => 'Cuando está activado, el sistema reducirá el tamaño de las imágenes grandes al subirlas, aplicándose a imágenes JPG, JPEG, PNG y WebP. El ancho y la altura máximos de la imagen se redimensionarán a los valores que usted establezca a continuación.',
        'image_max_width' => 'Ancho máximo de imagen (px)',
        'image_max_height' => 'Altura máxima de la imagen (px)',
        'image_max_width_placeholder' => 'Deje en blanco para mantener el ancho original',
        'image_max_height_placeholder' => 'Deje en blanco para mantener la altura original',
        'image_max_width_helper' => 'Establezca el ancho máximo de la imagen en píxeles. Se mantendrá el ancho original si este campo está vacío.',
        'image_max_height_helper' => 'Establezca la altura máxima de la imagen en píxeles. Se mantendrá la altura original si este campo está vacío.',
        'customize_upload_path' => 'Personalizar ruta de carga',
        'customize_upload_path_helper' => 'Personalice la ruta de carga para los archivos multimedia. De forma predeterminada, el sistema cargará los archivos en la carpeta ":path".',
        'upload_path' => 'Ruta de carga',
        'upload_path_placeholder' => 'ejemplos: subidas',
        'upload_path_helper' => 'Esa carpeta se creará en /public. La carpeta predeterminada es ":folder". Luego se subirá a "/public/:folder".',
        'upload_path_warning' => 'El sistema no moverá los archivos existentes a la nueva carpeta. Si desea mover los archivos existentes a la nueva carpeta, debe hacerlo manualmente.',
        'convert_file_name_to_uuid' => 'Convertir nombre de archivo a UUID',
        'convert_file_name_to_uuid_helper' => 'Cuando está habilitado, el sistema convertirá el nombre del archivo a UUID al cargarlo. Es útil para evitar nombres de archivo duplicados y mejorar la seguridad.',
        's3_path' => 'Ruta S3 personalizada (opcional)',
        's3_path_placeholder' => 'Ruta personalizada opcional en el bucket S3 (por ejemplo, uploads/media)',
    ],
    'license' => [
    ...
    'preview' => 'Avance',
    'media_size_width' => ':size El ancho del tamaño debe ser mayor que 0',
    'media_size_height' => ':size el tamaño de la altura debe ser mayor que 0',
    'cronjob' => [
        'name' => 'cronjob',
        ...
        'last_checked' => 'Última comprobación a las :time.',
        'copy_button' => 'Copiar',
        'setup' => [
            ...
            'learn_more' => 'Puede obtener más información sobre cronjob en la :documentation',
    ...
    'cache' => [
        ...
        'form' => [
            ...
            'cache_admin_menu_helper' => 'Cachear el menú de administración para optimizar la velocidad. Esta opción debe estar desactivada si está desarrollando o personalizando el menú de administración.',
            'enable_cache_site_map_helper' => 'El sitemap :url debe almacenarse en caché debido al gran número de páginas. Si tiene un número reducido de páginas, puede desactivar esta opción.',
            'cache_front_menu' => 'Menú principal de caché',
            'cache_front_menu_helper' => 'Cachear el menú principal para optimizar la velocidad',
            'cache_user_avatar' => 'Actualizar avatar de usuario',
            'cache_user_avatar_helper' => 'Para los usuarios sin avatar, el sistema generará avatares a partir de sus nombres de usuario. Los avatares se almacenarán en caché para optimizar la velocidad y no se regenerarán.',
        ],
    ],
    'appearance' => [
        'title' => 'Apariencia',
