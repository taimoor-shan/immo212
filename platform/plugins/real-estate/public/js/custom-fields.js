  ...
  var CustomField = /*#__PURE__*/function () {
    ...
    return _createClass(CustomField, [{
      ...
      value: function actions() {
        var _this2 = this;
        this.$customFieldWrapper.on('click', '#add-new', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          var id, data, index;
      ...
      key: "addFromGlobal",
      value: function () {
        var _addFromGlobal = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
