            ...
            <ul class="navbar-nav ml-auto my-2">
                ...
                @else
                        ...
                        >
                            <span>
                                <img
                                    ...
                                    src="{{ auth('account')->user()->avatar->url ? RvMedia::getImageUrl(auth('account')->user()->avatar->url, 'thumb') : auth('account')->user()->avatar_url }}"
                    ...
                    <li>
                        ...
                        >
                            <i
                                class="fas fa-cogs mr1"></i>{{ trans('plugins/real-estate::dashboard.header_settings_link') }}
                        </a>
                    </li>
                    @if (RealEstateHelper::isEnabledCreditsSystem())
                        <li>
                            <a
                                class="no-underline mr2 black-50 hover-black-70 pv1 ph2 db mr2 account-current-credit"
                                href="{{ route('public.account.packages') }}"
                                title="{{ trans('plugins/real-estate::account.credits') }}"
                                style="text-decoration: none; line-height: 32px;"
                            >
                                <i
                                    class="far fa-credit-card mr1"></i>{{ trans('plugins/real-estate::account.buy_credits') }}
                    ...
                    @endif
                        ...
                        >
                            <i class="fas fa-sign-out-alt mr1"></i><span
                                class="dn-ns">{{ trans('plugins/real-estate::dashboard.header_logout_link') }}</span>
                        </a>
                        <form
                            id="logout-form"
                            style="display: none;"
