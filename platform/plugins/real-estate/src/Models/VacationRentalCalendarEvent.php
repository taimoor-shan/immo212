...
class VacationRentalCalendarEvent extends BaseModel
{
    ...
    public static function getEventsForCalendar(int $vacationRentalId, Carbon $startDate, Carbon $endDate): array
    {
    ...
    public static function getMonthlyEvents(int $vacationRentalId, int $year, int $month): array
    {
        return self::forVacationRental($vacationRentalId)
            ->forMonth($year, $month)
            ->orderBy('start_date')
    ...
    public static function createBlockedPeriod(int $vacationRentalId, Carbon $startDate, Carbon $endDate, string $title = 'Blocked', ?string $notes = null): self
    {
        return self::create([
    ...
    public static function createMaintenancePeriod(int $vacationRentalId, Carbon $startDate, Carbon $endDate, string $title = 'Maintenance', ?string $notes = null): self
    {
        return self::create([
            'vacation_rental_id' => $vacationRentalId,
            'title' => $title,
    ...
    protected static function boot()
    {
        ...
        static::created(function ($event) {
            // Update rental availability when calendar events are created
