...
(() => {
/*!***************************************************************!*\
  !*** ./platform/themes/homzen/assets/js/frontend-calendar.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
  ...
  return _createClass(VacationRentalFrontendCalendar, [{
    ...
    value: function updateCalendarWithExceptions() {
      ...
      dayElements.forEach(function (dayElem) {
        ...
        _this.applyAvailabilityToDay(dayElem, date, availability);
      });
    ...
    value: function addTooltipToDate(dayElem, availability, status) {
      ...
      dayElem.addEventListener('mouseenter', function (e) {
        ...
        _this2.showTooltip(e.target, tooltipContent, status);
      });
    ...
    value: function initializeCalendar() {
      ...
      this.calendar = (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])('#frontend-calendar-picker', {
        ...
        onDayCreate: function onDayCreate(_, __, ___, dayElem) {
          ...
          var date = _this3.getApiDate(dayElem.dateObj);
          var availability = _this3.availabilityData[date];

          // Use the centralized method to apply availability
          _this3.applyAvailabilityToDay(dayElem, date, availability);
        },
        onChange: function onChange(selectedDates) {
          if (_this3.validateDateSelection(selectedDates)) {
            _this3.handleDateSelection(selectedDates);
          } else {
            // Clear invalid selection
            _this3.calendar.clear();
            _this3.showValidationError('Selected date range contains unavailable dates. Please select a different range.');
          }
        },
        onReady: function onReady() {
          _this3.addCustomStyles();
        },
        onMonthChange: function onMonthChange() {
          ...
          setTimeout(function () {
            _this3.updateCalendarWithExceptions();
          }, 100);
        }
      });
    }
    ...
    value: function () {
      var _proceedToBooking = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var guestName, guestEmail, guestPhone, guestsCount, termsAccepted, _document$querySelect2, checkInDateFormatted, checkOutDateFormatted, response, errorMessage, errorData, validationErrors, data;
    ...
    value: function () {
      var _sendInquiry = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        var guestName, guestEmail, guestPhone, guestsCount, inquiryMessage, emailRegex, _document$querySelect3, checkInDateFormatted, checkOutDateFormatted, csrfToken, response, data;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 3:
              ...
              inquiryMessage = prompt('Please enter your message or questions about this property:') || '';
              if (!(!guestName || !guestEmail)) {
                _context5.next = 11;
                break;
              }
            ...
            case 15:
              ...
              checkOutDateFormatted = this.checkOutDate.toISOString().split('T')[0];
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (calendarContainer) {
    var vacationRentalId = calendarContainer.dataset.vacationRentalId;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VacationRentalFrontendCalendar);
})();

/******/ })()
;
//# sourceMappingURL=frontend-calendar.js.map