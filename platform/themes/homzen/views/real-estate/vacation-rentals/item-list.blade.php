...
<div @class(['vacation-rental-item homeya-box list-style-1', $class]) @if ($vacationRental->latitude && $vacationRental->longitude) data-lat="{{ $vacationRental->latitude }}" data-lng="{{ $vacationRental->longitude }}" @endif>
