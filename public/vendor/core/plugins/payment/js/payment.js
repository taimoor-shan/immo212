...
/******/ 	"use strict";
/*!**********************************************************!*\
  !*** ./platform/plugins/payment/resources/js/payment.js ***!
  \**********************************************************/
...
BPayment.init = function () {
  ...
  $(document).off('click', '.payment-checkout-btn').on('click', '.payment-checkout-btn', function (event) {
    ...
    var submitInitialText = button.html();
    if (form.valid && !form.valid()) {
      return;
    }
    button.prop('disabled', true);
    button.html("<span class=\"spinner-border spinner-border-sm me-2\" role=\"status\"></span> ".concat(button.data('processing-text')));
